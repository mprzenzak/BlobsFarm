...
public class Services {
    ...
    public static void main(String[] args) throws IOException {
        ...
        do {
            ...
            initialAltruistsNumber = (initialBlobsNumber - initialKillersNumber) * Integer.parseInt(blobsProportion[0]) / Integer.parseInt(blobsProportion[1]);
            initialAggressorsNumber = initialBlobsNumber - initialAltruistsNumber - initialKillersNumber;
